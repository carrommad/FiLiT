...
#> 
#==============================================================================
def plot_Poincare_Lc(filename, intersect_Z, intersect_R, connection_length, limiter_Z, limiter_R):
	...
	for target in range(ntargets):
		...
		"""
		# - plotting points without color scale
		plt.plot(R[target,:], Z[target,:], 'o', markersize=0.5)
		"""
		...
		plt.scatter(intersect_R[target,:], intersect_Z[target,:], c=color, cmap=cm, s=size, alpha=transparency, marker='.', vmin=0.)
