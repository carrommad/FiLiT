...
filename = 'matrix_ntargets-81_nturns-50'
#filename = 'matrix_ntargets-2500_nturns-100'
...
plot_Poincare_Lc(filename, intersect_Z, intersect_R, connection_length, limiter_Z, limiter_R)
