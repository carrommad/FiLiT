...
# INPUTS
#------------------------------------------------------------------------------			
# - Set 'parallel' in script 'field_line_mod.py': serial (0), parallel (1)
   
mode       = 'matrix'          # Target's distribution: 'line' - 'matrix'

ntargets1D =  300              # Number of targets per line
...
# - parallel conditional printing
if parallel == 1:
	from field_line_mod import num_cores
	
	print('\n')
	print('==================================')
	print(' ATTENTION: parallel run seleted! ')
	...
	print('\n')
	print('======================================')
	print(' ATTENTION: parallel run not seleted! ')
	print('======================================')
